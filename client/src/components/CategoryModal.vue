      ...
      <form @submit.prevent="handleSubmit" class="mt-6 space-y-6">
          ...
          <div class="space-y-3">
            ...
            <div class="grid grid-cols-8 gap-2">
              <button
                ...
                :class="form.color === color ? 'border-gray-400 scale-110' : 'border-gray-200 hover:border-gray-300'"
            ...
            <div class="flex items-center space-x-3">
              <label for="custom-color" class="text-sm text-gray-600">自定义颜色：</label>
              <input
                id="custom-color"
                v-model="form.color"
                type="color"
        ...
        <div>
          ...
          <div class="p-4 bg-gray-50 rounded-lg">
            ...
            <span v-else class="text-gray-400 text-sm">输入分类名称查看预览</span>
          </div>
        </div>
